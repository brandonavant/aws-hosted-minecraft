...
Fetches the live issue body via ``gh issue view`` and compares it against the expected content on disk. Exits 0 on
match, 1 on mismatch or fetch failure.
...
def normalize(text: str) -> str:
    ...
    Returns:
        Text with trailing whitespace stripped from each line and a single trailing newline.
    """
